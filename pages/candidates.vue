<script setup>
	...
	const tableRowMap = new Map([
		[
			...
			{
				property: "rating",
				visilibility: "isRatingVisible",
				component: resolveComponent("CandidatesTableDataRating"),
			},
		],
		[
			"Stages",
			{
				property: "stages",
				visilibility: "isStagesVisible",
				component: resolveComponent("CandidatesTableDataStages"),
			},
		],
		[
			"Team",
			{
				property: "team",
				visilibility: "isTeamVisible",
				component: resolveComponent("CandidatesTableDataTeam"),
			},
		],
		[
			"Applied Date",
			{
				...
				visilibility: "isDateVisible",
				component: resolveComponent("CandidatesTableDataDate"),
			},
		],
		[
			"Owner",
			{
				property: "owner",
				visilibility: "isOwnerVisible",
				component: resolveComponent("CandidatesTableDataOwner"),
			},
		],
	]);
